...
#### listFile.readLine(path:String, startFromCurrentModDirectory:Boolean, ?linePosition:Integer)
...
#### listFile.write(path:String, tableToInsert:Table, startFromCurrentModDirectory:Boolean)
